...
<html lang="en">
  ...
  <body>
    ...
    <div class="flex-row my-3 my-md-0">
        ...
        <a href="/chat"> <span class="text-white mr-2 header-chat-icon" title="Chat" data-toggle="tooltip" data-placement="bottom"><i class="fas fa-comment"></i></span></a>
        ...
        <a class="btn btn-sm btn-success mr-2" href="createposts">Create Post</a>
